...
public class CCDivider extends AbstractWidget {
    ...
    protected void extractWidgetRenderState(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (this.isHovered && CoreconfigClient.hoveredEntry != entry) CoreconfigClient.hoveredEntry = entry;
        else if (CoreconfigClient.hoveredEntry == entry) CoreconfigClient.hoveredEntry = null;
