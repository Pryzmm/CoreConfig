    ...
    protected void init() {
        ...
        try {
            for (CCEntry entry : EntryHolder.get(activeModID)) {
                ...
                switch (entry) {
                    case BooleanEntry booleanEntry -> configWidgets.add(new CCButtonBoolean(booleanEntry, configContainer.ccGetWidth(), 20, booleanEntry.translation(),  configContainer, booleanEntry.hoverColor() != null ? booleanEntry.hoverColor() : 0x55000000, data.buttonColor()));
                    case StringEntry  stringEntry  -> configWidgets.add(new CCButtonString(stringEntry,   configContainer.ccGetWidth(), 20, stringEntry.translation(),   configContainer, stringEntry.hoverColor()  != null ? stringEntry.hoverColor()  : 0x55000000, data.buttonColor()));
                    case IntegerEntry integerEntry -> configWidgets.add(new CCButtonInteger(integerEntry, configContainer.ccGetWidth(), 20, integerEntry.translation(),  configContainer, integerEntry.hoverColor() != null ? integerEntry.hoverColor() : 0x55000000, data.buttonColor()));
                    case FloatEntry   floatEntry   -> configWidgets.add(new CCButtonFloat(floatEntry,     configContainer.ccGetWidth(), 20, floatEntry.translation(),    configContainer, floatEntry.hoverColor()   != null ? floatEntry.hoverColor()   : 0x55000000, data.buttonColor()));
                    case DoubleEntry  doubleEntry  -> configWidgets.add(new CCButtonDouble(doubleEntry,   configContainer.ccGetWidth(), 20, doubleEntry.translation(),   configContainer, doubleEntry.hoverColor()  != null ? doubleEntry.hoverColor()  : 0x55000000, data.buttonColor()));
                    case LongEntry    longEntry    -> configWidgets.add(new CCButtonLong(longEntry,       configContainer.ccGetWidth(), 20, longEntry.translation(),     configContainer, longEntry.hoverColor()    != null ? longEntry.hoverColor()    : 0x55000000, data.buttonColor()));
                    case ColorEntry   colorEntry   -> configWidgets.add(new CCButtonColor(colorEntry,     configContainer.ccGetWidth(), 20, colorEntry.translation(),    configContainer, colorEntry.hoverColor()   != null ? colorEntry.hoverColor()   : 0x55000000, data.buttonColor()));
                    case WebsiteEntry websiteEntry -> configWidgets.add(new CCButtonWebsite(websiteEntry, configContainer.ccGetWidth(), 20, websiteEntry.translation(),  configContainer, websiteEntry.hoverColor() != null ? websiteEntry.hoverColor() : 0x55000000, data.buttonColor()));
                    case EnumEntry    enumEntry    -> configWidgets.add(new CCButtonEnum(enumEntry,       configContainer.ccGetWidth(), 20, enumEntry.translation(),     configContainer, enumEntry.hoverColor()    != null ? enumEntry.hoverColor()    : 0x55000000, data.buttonColor()));
                    case CustomEntry  customEntry  -> configWidgets.add(new CCButtonCustom(customEntry,   configContainer.ccGetWidth(), 20, customEntry.translation(),   configContainer, customEntry.hoverColor()  != null ? customEntry.hoverColor()  : 0x55000000, data.buttonColor()));
                    case DividerEntry dividerEntry -> configWidgets.add(new CCDivider(dividerEntry, configContainer.ccGetWidth(), configWidgets.isEmpty() ? 20 : 30, dividerEntry.translation(), configContainer, dividerEntry.textColor()));
