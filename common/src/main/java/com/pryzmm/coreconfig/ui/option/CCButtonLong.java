...
import com.pryzmm.coreconfigapi.entry.LongEntry;
...
public class CCButtonLong extends AbstractWidget {

    private final CCContainer container;
    private final String translation;
    private final Integer color;
    private final int hoverColor;
    private final LongEntry entry;
    private final EditBox editBox;

    public CCButtonLong(LongEntry entry, int width, int height, String translation, CCContainer assignedContainer, int hoverColor, Integer color) {
    ...
    protected void renderWidget(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float a) {
        ...
        long value = 0;
        try { value = Long.parseLong(editBox.getValue()); canParse = true; } catch (Exception ignored) {}
    ...
    private static boolean equals(Long value, Object unsavedValue) {
        try {
            long finalValue = Long.parseLong(unsavedValue.toString());
