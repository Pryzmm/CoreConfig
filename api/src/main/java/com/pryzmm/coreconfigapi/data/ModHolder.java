...
public class ModHolder {
    ...
    public static void addRegisteredMod(String modID, String nameTranslation, String bannerPath, Integer backgroundColor, Integer buttonColor) {
        ModData data = new ModData(modID, nameTranslation, bannerPath, backgroundColor, buttonColor);
    ...
    public static String getModByNamespace(String namespace) {
        return configEntries.keySet().stream().filter(id -> id.equals(namespace)).findFirst().orElse(null);
    }
