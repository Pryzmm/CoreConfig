...
public class IntegerEntry implements MainEntry {
    ...
    public static class Builder {
        ...
        public IntegerEntry build() {
            ...
            if (!ConfigValidity.validateIntConfig(String.valueOf(defaultValue), entry.minimum, entry.maximum)) {
                Constants.LOGGER.warn("Default value for {}:{} is out of bounds. This may have unintended consequences.", modID, translation);
            }

            boolean validated = ConfigValidity.validateIntConfig(configValue != null ? String.valueOf(configValue) : String.valueOf(defaultValue), entry.minimum, entry.maximum);
