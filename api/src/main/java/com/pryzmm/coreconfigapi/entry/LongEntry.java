...
/**
 * A configuration option for CoreConfig, dedicated towards longs. Use the {@link Builder} to create a new LongEntry for use in mods.
 * <p>
 * Visit <a href="https://github.com/Pryzmm/CoreConfig/wiki/Entries#longentry">the wiki page</a> to view more detailed documentation regarding this entry and its builder methods.
 */
public class LongEntry implements MainEntry {
    ...
    public void save() {
        if (newValue != null) {
            if (!requiresRestart) setValue(Long.valueOf(newValue));
        }
    }
    ...
    public static class Builder {
        ...
        public Builder(String modID, String translation, Long defaultValue) {
        ...
        public Builder minimum(long minimum) { this.minimum = minimum; return this; }
        public Builder maximum(long maximum) { this.maximum = maximum; return this; }
        ...
        public LongEntry build() {
            ...
            Long configValue = CCFile.getInstance().getConfigValue(modID, translation, Long.class);

            if (!ConfigValidity.validateLongConfig(String.valueOf(defaultValue), entry.minimum, entry.maximum)) {
                Constants.LOGGER.warn("Default value for {}:{} is out of bounds. This may have unintended consequences.", modID, translation);
            }

            boolean validated = ConfigValidity.validateLongConfig(configValue != null ? String.valueOf(configValue) : String.valueOf(defaultValue), entry.minimum, entry.maximum);
